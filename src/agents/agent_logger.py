...
#         content = llm_response["candidates"][0]["content"]["parts"][0]["text"].strip()
...
#         agent_history_collection.insert_one(agent_history.dict())
...
"""
    ...
    try:
        ...
        agent_history = AgentHistory(
            ...
            status=AgentStatus(parsed.get("status")),
            execution_time=execution_time,
            result_summary=parsed.get("result_summary"),
            user_id=user_id
        )
